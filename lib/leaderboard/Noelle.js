...
export default class Noelle {
  ...
  getDamage(enemy) {
    ...
    const normalScaling = [
      ...
      [ 0.7336, 0.7933, 0.8530, 0.9383, 0.9980, 1.0662, 1.1601, 1.2539, 1.3477, 1.4501, 1.5525 ],
      [ 0.8626, 0.9328, 1.0030, 1.1033, 1.1735, 1.2537, 1.3641, 1.4744, 1.5847, 1.7051, 1.8255 ],
      [ 1.1343, 1.2267, 1.3190, 1.4509, 1.5432, 1.6488, 1.7938, 1.9389, 2.0840, 2.2423, 2.4006 ],
    ];
    ...
    return normalScaling.map(scaling => {
